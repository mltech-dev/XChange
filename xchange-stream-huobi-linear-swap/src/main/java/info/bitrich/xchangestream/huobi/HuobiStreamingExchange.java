...
import org.knowm.xchange.huobi.HuobiLinearSwapExchange;
...
public class HuobiStreamingExchange extends HuobiLinearSwapExchange implements StreamingExchange {
  private static final String API_BASE_URI = "wss://www.btcgateway.pro/linear-swap-ws";
