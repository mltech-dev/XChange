...
import static info.bitrich.xchangestream.binance.BinanceFuturesStreamingExchange.USE_HIGHER_UPDATE_FREQUENCY;
import static info.bitrich.xchangestream.binance.BinanceFuturesStreamingExchange.USE_REALTIME_BOOK_TICKER;
...
public class BinanceIntegration {
  ...
  public void channelCreateUrlTest() {
    BinanceFuturesStreamingExchange exchange =
        (BinanceFuturesStreamingExchange)
            StreamingExchangeFactory.INSTANCE.createExchange(BinanceFuturesStreamingExchange.class);
  ...
  public void channelCreateUrlWithUpdateFrequencyTest() {
    ...
    BinanceFuturesStreamingExchange exchange =
        (BinanceFuturesStreamingExchange) StreamingExchangeFactory.INSTANCE.createExchange(spec);
    String buildSubscriptionStreams = exchange.buildSubscriptionStreams(builder.build());
    Assert.assertEquals(
