...
public class BinanceUserDataStreamingService extends JsonNettyStreamingService {
  ...
  public static BinanceUserDataStreamingService create(String path,String listenKey) {
    return new BinanceUserDataStreamingService(path + USER_API_URI + listenKey);
  }
