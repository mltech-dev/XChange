...
import org.knowm.xchange.binance.service.BinanceFuturesTradeService.BinanceOrderFlags;
...
public class BinanceAdapters {
  ...
  public static Order adaptOrder(BinanceOrder order) {
    ...
    if (order.executedQty.signum() != 0 && (order.cummulativeQuoteQty!=null && order.cummulativeQuoteQty.signum() != 0)) {
