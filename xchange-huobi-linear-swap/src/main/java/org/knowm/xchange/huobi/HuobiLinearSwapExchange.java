...
public class HuobiLinearSwapExchange extends BaseExchange implements Exchange {
  ...
  public ExchangeSpecification getDefaultExchangeSpecification() {
    ...
    exchangeSpecification.setExchangeName("Huobi Linear Swap");
    exchangeSpecification.setExchangeDescription(
        "Huobi linear swap Futures is a Chinese digital currency trading platform and exchange based in Beijing");
